...
const MainData = () => {
  ...
  return (
    <>
      <MetaData title="Admin Dashboard | The Whole Kart" />
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-8 w-auto flex-wrap">
        <div className="bg-white rounded-xl  w-full shadow-lg p-2">
          <Line data={lineState} />
        </div>

        <div className="bg-white rounded-xl shadow-lg p-4 text-center  w-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-8  w-full mb-6">
        <div className="bg-white rounded-xl  w-full shadow-lg p-2">
          <Bar data={barState} />
        </div>

        <div className="bg-white rounded-xl shadow-lg p-4 text-center  w-full">
          <span className="font-medium uppercase text-gray-800">
            Stock Status
          </span>
