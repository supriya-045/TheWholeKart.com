...
const NewProduct = () => {
  ...
  return (
    <>
      <MetaData title="Admin: New Product | The Whole Kart" />

      {loading && <BackdropLoader />}
      <form
        onSubmit={newProductSubmitHandler}
        encType="multipart/form-data"
        className="flex flex-col sm:flex-row bg-white rounded-lg shadow p-4 flex-wrap w-full overflow-hidden "
        id="mainform"
      >
        <div className="flex flex-col gap-3 m-2 sm:w-10/12">
          <TextField
            label="Name"
            variant="outlined"
            size="small"
          ...
          <div className="flex justify-between gap-4 items-start sm:w-10/12">
            <TextField
              label="Brand"
              type="text"
              variant="outlined"
        ...
        <div className="flex flex-col gap-2 m-2 w-10/12 justify-start ">
