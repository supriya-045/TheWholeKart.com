              ...
              <div className="flex-1 overflow-hidden shadow bg-white">
                ...
                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                  ...
                  <div className="flex flex-col gap-4 mt-4">
                    ...
                    <p className="text-sm">
                      Your login email id changes, likewise. You'll receive all
                      your account related communication on your updated email
                      address.
                    </p>

                    <h4 className="text-sm font-medium">
                      When will my TheWholeKart account be updated with the new
                      email address ?
                    </h4>
                    <p className="text-sm">
                      It happens as soon as you confirm the verification code
                      sent to your email and save the changes.
                    </p>

                    <h4 className="text-sm font-medium">
                      What happens to my existing TheWholeKart account when I
                      update my email address ?
                    </h4>
                    <p className="text-sm">
                      Updating your email address doesn't invalidate your
                      account. Your account remains fully functional. You'll
                    ...
                    <p className="text-sm">
                      TheWholeKart has a 'single sign-on' policy. Any changes
