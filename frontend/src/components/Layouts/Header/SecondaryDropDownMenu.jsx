  ...
  const navs = [
    {
      ...
      redirect: "https://www.TheWholeKart.com/communication-preferences/push",
    },
    {
      title: "Sell on TheWholeKart",
      icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
      redirect: "https://seller.TheWholeKart.com/sell-online",
    },
    {
    ...
    },
    {
      ...
      redirect: "https://advertising.TheWholeKart.com",
    },
    {
      title: "Download App",
      icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
      redirect: "https://www.TheWholeKart.com/mobile-apps",
    },
  ];
